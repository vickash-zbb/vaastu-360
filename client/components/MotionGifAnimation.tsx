  ...
  useEffect(() => {
    ...
    mainTimeline
      ...
      .fromTo(
        ".scan-line",
        { x: -200, opacity: 0 },
        { x: 200, opacity: 1, duration: 1.5, ease: "power2.inOut" },
        "scan+=0.5",
      )
      .fromTo(
        ".ai-brain",
      ...
      .to(
        ".ai-brain",
        { scale: 1.2, duration: 0.3, yoyo: true, repeat: 2 },
        "scan+=1.2",
      );
      ...
      <div className="upload-icon absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="text-center">
          <div className="w-32 h-32 bg-primary/20 rounded-full flex items-center justify-center mb-6 mx-auto shadow-2xl border-4 border-primary/10">
            <span className="material-icons-outlined text-6xl text-primary">
              cloud_upload
            </span>
          </div>
          <div className="upload-text text-primary text-3xl font-bold">
            Upload Floor Plan
          </div>
          <div className="text-primary/80 text-lg mt-2">
            Drag & drop your blueprint
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="text-center">
            <div className="relative h-20 mb-3">
              <div
                className="chart-bar absolute bottom-0 left-1/2 transform -translate-x-1/2 w-6 bg-green-500 rounded-t shadow-sm"
                style={{ height: "60%" }}
              ></div>
              <div
                className="chart-bar absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-x-3 w-6 bg-blue-500 rounded-t shadow-sm"
                style={{ height: "80%" }}
              ></div>
              <div
                className="chart-bar absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-x-3 w-6 bg-orange-500 rounded-t shadow-sm"
                style={{ height: "40%" }}
              ></div>
            </div>
          ...
          <div className="text-center">
            <div className="relative h-20 mb-3">
              <div
                className="chart-bar absolute bottom-0 left-1/2 transform -translate-x-1/2 w-6 bg-primary rounded-t shadow-sm"
                style={{ height: "70%" }}
              ></div>
              <div
                className="chart-bar absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-x-3 w-6 bg-purple-500 rounded-t shadow-sm"
                style={{ height: "50%" }}
              ></div>
            </div>
